...
<div class="container my-5">
    ...
    <div class="mb-4">
        ...
        <form method="GET" action="{{ url('reports/evaluation') }}" class="filter-form">
            ...
            <!-- Date Filters -->
            <span> <label for="">From</label> <input type="date" name="date_from" class="form-modern"
                    value="{{ request('date_from') }}"></span>
            <span> <label for="">To</label> <input type="date" name="date_to" class="form-modern"
                    value="{{ request('date_to') }}"></span>
                ...
                <table class="table table-hover align-middle">
                    <thead>
                        <tr>
                            ...
                            <th><i class="fa-solid fa-thumbs-up m-1"></i> \ <i class="fa-solid fa-thumbs-down"></i> Is
                                Satisfied</th>
