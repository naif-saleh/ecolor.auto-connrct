...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('users.files.create', $agent) }}" class="btn btn-secondary btn-sm ml-2">Add File</a>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <!-- view Button -->
                                        <a href="{{ route('users.files.show', $file->slug)}}" type="button" class="btn btn-info btn-sm mx-1">
                                            <i class="bi bi-eye"></i>
                                        </a>
        ...
        <!-- Back to agents list -->
        <a href="{{ route('users.index') }}" class="btn btn-primary mt-3">Back to Agents</a>
    </div>
@endsection
