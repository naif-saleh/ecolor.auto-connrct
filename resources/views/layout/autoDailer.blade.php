                ...
                @if (Auth::check() && (Auth::user()->isSuperUser() || Auth::user()->isAdmin()))
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0"> <!-- Left-aligned links -->
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('manager.auotdailer.report.extension') }}">Per Extensions</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('manager.auotdailer.report.providers') }}">Per Providers</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Per Compaign</a>
                            </li>
                            {{-- <li class="nav-item">
                                <a class="nav-link" href="{{ route('manager.autodistributor.report.extension') }}">Auto Distributor Reports</a>
                            </li> --}}
