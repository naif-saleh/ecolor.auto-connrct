...
class ADistWebhookBatch extends Model
{
    protected $fillable = [
        'batch_id',
        'status',
    ...
    {
        return $this->hasMany(ADistFeed::class, 'webhook_batch_id');
    }
    ...
    {
        return $this->hasMany(ADistSkippedNumbers::class, 'webhook_batch_id');
    }
}
